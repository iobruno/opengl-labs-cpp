...
int main(void)
{
	...
	// Nossa ModelViewProjection : multiplica��o de nossas 3 matrizes
	glm::mat4 MVP = Projection * View * Model; // Lembrem-se, a multiplica��o de matrizes � inversa
	...
	static const GLfloat g_vertex_buffer_data[] = {
		-1.0f,-1.0f,-1.0f, // triângulo 1 : inicio
		-1.0f,-1.0f, 1.0f,
		-1.0f, 1.0f, 1.0f, // triângulo 1 : fim
		1.0f, 1.0f,-1.0f, // triângulo 2 : inicio
		-1.0f,-1.0f,-1.0f,
		-1.0f, 1.0f,-1.0f, // triângulo 2 : fim
		1.0f,-1.0f, 1.0f,
		-1.0f,-1.0f,-1.0f,
		1.0f,-1.0f,-1.0f,
		1.0f, 1.0f,-1.0f,
	...
	// Uma cor RGB aleatória para cada vétice. 
